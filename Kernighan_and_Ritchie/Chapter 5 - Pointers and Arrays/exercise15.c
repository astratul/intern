...
int main(int argc, char *argv[]){
    ...
    if (argc)
        ...
        if ((nlines = readlines(lineptr, LINES)) > 0){
            if (option & NUMERIC)
                qsort2((char **)lineptr, 0, nlines - 1, (int (*)(void *, void *))numcmp);
            else if (option & FOLD)
                qsort2((char **)lineptr, 0, nlines - 1, (int (*)(void *, void *))charcmp);
            else
                qsort2((char **)lineptr, 0, nlines - 1, (int (*)(void *, void *))strcmp);
